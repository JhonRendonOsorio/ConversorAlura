...
public class DePesoAYenJapones extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DePesoAYenJapones frame = new DePesoAYenJapones();
	...
	public DePesoAYenJapones() {
		...
		lblNewLabel.setBounds(26, 71, 255, 13);
		...
		btnConvertir2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double valorEnYen = valorEnPesos / 34.17; 
				
				String resultado = valorIngresado+" pesos Colombianos son : " +Math.round (valorEnYen)+" Yenes";
				
				JOptionPane.showMessageDialog(null, resultado);
			}
		});
		btnConvertir2.setBounds(29, 208, 131, 21);
		...
		btnNewButton.setBounds(234, 208, 131, 21);
